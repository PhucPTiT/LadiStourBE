...
public interface InterfaceToursService {
    ...
    MessageResponse createOrUpdateMultiLanguage(ToursMultiLanguageRequest req);
    MessageResponse createOrUpdateMultiLanguage(String id, ToursMultiLanguageRequest req);
